...
public class TestEventoMB {
	...
	@Test
	public void testRetornarPontuacaoJogadorNovo() {

		EventoMB servico = new EventoMB();
		Jogador jogador = new Jogador("David");
	...
	@Test
	public void testRetornarPontuacaoJogadorExistente() {
		EventoMB servico = new EventoMB();
		Jogador jogador = new Jogador("David");
	...
	@Test
	public void testAdicionarMorte() {
		EventoMB servico = new EventoMB();
		Jogador matador = new Jogador("matador");
		Jogador morto = new Jogador("morto");
		Arma arma = new Arma("arma");
		Morte morte = new Morte(matador, morto, arma, new Date());
		Partida partida = new Partida(new Date(), "nomePartida");
	...
	@Test
	public void testCriarNovaPartida() {
		EventoMB servico = new EventoMB();
		Date data = new Date();
	...
	@Test
	public void testAdicionarCincoMortesUmMinuto() {
		EventoMB servico = new EventoMB();
		Jogador matador = new Jogador("matador");
		Jogador morto = new Jogador("morto");
		Arma arma = new Arma("arma");
	...
	@Test
	public void testAdicionarCincoMortesMaisDeUmMinuto() {
		EventoMB servico = new EventoMB();
		Jogador matador = new Jogador("matador");
		Jogador morto = new Jogador("morto");
		Arma arma = new Arma("arma");
	...
	@Test
	public void testAdicionarCincoMortesUmMinutoFim() {
		EventoMB servico = new EventoMB();
		Jogador matador = new Jogador("matador");
		Jogador morto = new Jogador("morto");
		Arma arma = new Arma("arma");
